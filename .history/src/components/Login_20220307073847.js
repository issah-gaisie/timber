...
const Login = () => {
  ...
  return (
    ...
    >
      <h1 className="font-bold text-left w-full md:w-[30rem] text-gray-800 text-2xl md:text-3xl mb-6">
          Sign In
        </h1>
      ...
      <label className="block flex flex-col">
        ...
        <Link to="/password-reset" className="self-end text-sm text-blue-600 hover:underline mt-2 ">Forgot Password?</Link>
      </label>
      <button
        type="submit"
