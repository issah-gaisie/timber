    ...
    <div className="flex flex-col items-center bg-white shadow-md rounded rounded-lg absolute right-0 top-[125%] p-3 w-40 ">
      ...
      <div className="flex space-x-4 mt-4">
        <button className="group">
          <RiSettings5Line className="group-hover:hidden text-4xl" />
          <RiSettings5Fill className="hidden group-hover:block" />
        </button>
        <button className="group">
          <RiShutDownLine className="group-hover:hidden" />
          <RiShutDownFill className="hidden group-hover:block" />
        </button>
      </div>
