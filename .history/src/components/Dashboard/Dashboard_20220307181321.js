...
const arrow =useMemo(showPopup?<FaAngleUp/:<FaAngleDown />,[showPopup])
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-gray-100">
      <div className="flex justify-between items-center h-14 shadow-sm bg-white px-6">
        ...
        <div className="group hover:ring-2 hover:ring-green-700/25 hover:p-1 rounded rounded-md flex justify-center items-center space-x-2 pointer">
