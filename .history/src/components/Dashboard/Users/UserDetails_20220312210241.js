...
import Input disabled from "../../Input disabled";
const UserDetails = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center  bg-white p-6 rounded rounded-lg">
      ...
      <UserDetailsGrid>
        <label className="block">
          ...
          <Input disabled placeholder="Username" type="text" value={state.username} />
        </label>
        <label className="block">
          <span className="block text-md  text-gray-700 mb-3">First Name</span>
          <Input disabled placeholder="First Name" type="text" value={state.firstName} />
        </label>
        <label className="block">
          <span className="block text-md  text-gray-700 mb-3">Last Name</span>
          <Input disabled placeholder="Last Name" type="text" value={state.lastName} />
        </label>
        <label className="block">
          <span className="block text-md  text-gray-700 mb-3">
            Email Address
          </span>
          <Input disabled placeholder="Email Address" type="email" value={state.email} />
        </label>
        <label className="block">
          <span className="block text-md  text-gray-700 mb-3">
            Phone Number
      ...
      <UserDetailsGrid>
        <label className="block">
          ...
          <Input disabled placeholder="Location" type="text" value={state.location} />
        </label>
        <label className="block">
          <span className="block text-md  text-gray-700 mb-3">Address 1</span>
          <Input disabled placeholder="Address 1" type="text" value={state.address1} />
        </label>
        <label className="block">
          <span className="block text-md  text-gray-700 mb-3">Address 2</span>
          <Input disabled placeholder="Address 2" type="text" value={state.address2} />
        </label>
      </UserDetailsGrid>
    </div>
  );
