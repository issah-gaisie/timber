...
const UserCard = (props) => {
  ...
  return (
    <div className={`bg-white rounded rounded-lg flex justify-center items-center flex-col p-3 space-y-3 shadow shadow-sm hover:shadow-lg ${className} max-w-[20rem]`}>
