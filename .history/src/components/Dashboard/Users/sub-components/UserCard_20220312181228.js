...
const UserCard = (props) => {
  ...
  return (
    <div
      className={`bg-white rounded rounded-full flex justify-center items-center flex-col p-3 space-y-2 shadow shadow-sm hover:shadow-lg ${className} `}
    >
...
export const ActiveUser = () => {
  return <UserCard className="ring-2 ring-[#4B971C]/75" />;
};

export const DeactivatedUser = () => {
  return <UserCard className="ring-2 ring-red-400/75" />;
};
