...
const UserCard = (props) => {
  ...
  return (
    <div
      className={`bg-white rounded rounded-lg flex justify-center items-center flex-col p-3 space-y-3 shadow shadow-sm hover:shadow-lg ${className} min-w-[200px]`}
    >
      ...
      {active ? (
        ...
        <span className="text-green-600">Deactivated</span>
      )}
    </div>
  );
};
