...
const UserCard = (props) => {
  ...
  return (
    <div
      className={`bg-white rounded rounded-2xl flex justify-center items-center flex-col py-4 px-3  shadow shadow-sm hover:shadow-lg  `}
    >
      ...
      <div className="h-16 w-16 relative mb-5">
        ...
        {active ? (
          ...
          <span className="w-full block text-center absolute -bottom-1 uppercase rounded rounded-full bg-red-100 text-red-800/50 font-medium px-2 text-[0.7rem]">
            Disabled
          </span>
        )}
      </div>
