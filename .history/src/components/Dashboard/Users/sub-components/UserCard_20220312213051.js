...
const UserCard = (props) => {
  ...
  return (
    <div
      className={`bg-white rounded rounded-2xl flex justify-center items-center flex-col py-4 px-3  shadow shadow-sm hover:shadow-lg ${className} `}
    >
      ...
      {/* Name */}
      <h2 className="font-semibold text-gray-600">{firstName} {lastName}</h2>
