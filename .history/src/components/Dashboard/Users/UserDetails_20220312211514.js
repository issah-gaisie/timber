  ...
  return (
    <div className="w-full flex flex-col bg-white p-6 rounded rounded-lg relative">
      ...
      <div className="absolute top-6 right-6 flex items-center">
        <button className="text-sm text-slate-600 bg-slate-200 px-2 py-0.5 rounded rounded-full mr-2 hover:font-medium hover:ring-2 hover:ring-slate-600/50">Edit</button>
        {state.active ? (
          <button className="text-sm text-red-600 bg-red-200 px-2 py-0.5 rounded rounded-full hover:font-medium hover:ring-2 hover:ring-slate-600/50">Deactivate</button>
        ) : (
          <button className="text-sm text-green-600 bg-green-200 px-2 py-0.5 rounded rounded-full hover:font-medium hover:ring-2 hover:ring-slate-600/50">Activate</button>
        )}
      </div>
