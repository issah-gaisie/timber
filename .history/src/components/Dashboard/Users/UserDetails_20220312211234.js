  ...
  return (
    <div className="w-full flex flex-col bg-white p-6 rounded rounded-lg relative">
      ...
      <div className="absolute top-10 right-10 flex items-center">
        <button className="text-sm text-slate-600 bg-slate-200 px-2 py-0.5 rounded rounded-full">Edit</button>
        {state.active ? (
          <button className="text-sm text-slate-600 bg-slate-200 px-2 py-0.5 rounded rounded-full">Deactivate</button>
        ) : (
          <button className="text-sm text-slate-600 bg-slate-200 px-2 py-0.5 rounded rounded-full">Activate</button>
        )}
      </div>
