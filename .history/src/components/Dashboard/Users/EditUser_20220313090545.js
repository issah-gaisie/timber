    ...
    <form className="w-full flex flex-col" onSubmit={handleSubmit}>
      ...
      <FormGrid>
        <label className="block">
          ...
          <Input placeholder="Username" id='username' type="text" hand value={state.username}  />
        </label>
        <label className="block">
          <span className="block text-md  text-gray-700 mb-3">First Name</span>
          <Input placeholder="First Name" id='firstName' type="text" hand value={state.firstName} />
        </label>
        <label className="block">
          <span className="block text-md  text-gray-700 mb-3">Last Name</span>
          <Input placeholder="Last Name" type="text" id='lastName' hand value={state.lastName} />
        </label>
        <label className="block">
          <span className="block text-md  text-gray-700 mb-3">
            Email Address
          </span>
          <Input placeholder="Email Address" type="email" id='email' hand value={state.email} />
        </label>
        <label className="block">
          <span className="block text-md  text-gray-700 mb-3">
            Phone Number
      ...
      <FormGrid>
        <label className="block">
          ...
          <Input placeholder="Location" type="text" id='location' hand value={state.location} />
        </label>
        <label className="block">
          <span className="block text-md  text-gray-700 mb-3">Address 1</span>
          <Input placeholder="Address 1" type="text" id='address1' hand value={state.address1} />
        </label>
        <label className="block">
          <span className="block text-md  text-gray-700 mb-3">Address 2</span>
          <Input placeholder="Address 2" type="text" id='address2' hand value={state.address2} />
        </label>
      </FormGrid>
