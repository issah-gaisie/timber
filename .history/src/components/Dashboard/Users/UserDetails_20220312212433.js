  ...
  return (
    <div className="w-full flex flex-col bg-white p-6 items-center md:items-start rounded rounded-lg relative">
      ...
      <div className="md:absolute md:top-6 md:right-6 justify-center space-x-2 flex items-center mb-2 ">
        <Lin className="text-sm text-slate-600 bg-slate-200 px-2 py-0.5 rounded rounded-full mr-2 hover:font-medium hover:ring-2 hover:ring-slate-600/50 flex items-center"><RiEditLine className="mr-1"/> Edit</Lin>
        {state.active ? (
