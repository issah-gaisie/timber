...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-gray-100">
      <div className="flex justify-between items-center h-14 shadow-sm bg-white px-6 relative">
...
const SettingsPopup = () => {
  return (
    <div className="flex flex-col items-center bg-white shadow-md rounded rounded-lg absolute right-0 top-full p-3 w-40 ">
