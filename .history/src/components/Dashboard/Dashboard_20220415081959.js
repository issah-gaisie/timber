    ...
    <div className="flex flex-col h-screen w-screen bg-gray-100">
      ...
      <header className="flex justify-between items-center h-[7vh] shadow-sm bg-white px-2 md:px-6 relative">
        ...
        <div className="flex justify-center items-center space-x-2 pointer">
          ...
          <Menu
            className={`box-border absolute z-50 text-sm bg-white p-1.5 border rounded-md shadow-lg select-none focus:outline-none min-w-[9rem]`}
            menuButton={<MenuButton>Open menu</MenuButton>}
          >
            <MenuItem className="bg-red">New File</MenuItem>
