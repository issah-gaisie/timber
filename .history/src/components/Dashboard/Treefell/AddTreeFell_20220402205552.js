    ...
    <form className="w-full flex flex-col" onSubmit={handleSubmit}>
      ...
      <FormGrid>
        <label className="block">
          ...
          <Select placeholder="Manager"  options={[]}  type="text" value={state.managerId} />
        </label>
        <label className="block">
        ...
        <label className="block">
          ...
          <Select  options={[]}  placeholder="Team" value={state.teamId} />
        </label>
        <label className="block">
          <span className="block text-md  text-gray-700 mb-3">Clerk</span>
          <Select options={[]} value={state.clerkId} />
        </label>
        <label className="block">
