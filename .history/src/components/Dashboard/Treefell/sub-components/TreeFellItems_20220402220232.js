  ...
  return (
    <div className="w-full">
      {treeFellItems.map((p, index) => {
        return (
          <div className="flex space-x-3 mb-" key={p.id}>
            ...
            <button
              className="text-white flex items-center justify-center rounded rounded-lg text-lg"
              onClick={() => {
                setTreeFellItems((currentTreeFellItems) =>
          ...
          </div className="flex space-x-3 mb-">
        );
      })}
      <button
