...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-gray-100">
      {/* Dashboard Header */}
      <header className="flex justify-between items-center h-[5vh] shadow-sm bg-white px-2 md:px-6 relative">
      ...
      <main className="flex w-full h-full relative">
        <Sidebar />
        <section className="w-full h-96 overflow-y-auto bg-gray-100">
          <Outlet />
        </section>
