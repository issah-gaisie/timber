...
const NotificationDropdown = ({ visible, hide }) => {
  ...
  return (
    <div
      hidden={!visible}
      onMouseDown={hide}
      className={`w-96 absolute top-[140%] right-0 h-30 bg-gray-200 rounded rounded-md shadow-md z-40`}
    >
...
const NotificationItem = ({
  ...
  return (
    <p className="w-full last:border-none border-b border-gray-300 py-2 text-gray-300">
      {item}
    </p>
  );
};
