...
const NotificationItem = ({
  ...
  return (
    <p className="w-full last:border-none rounded-t rounded-b-none last:rounded-t-none rounded-md last:rounded-b last:rounded-md border-b border-gray-100 p-2 text-gray-700 hover:bg-gray-100">
      {item}
    </p>
  );
};
