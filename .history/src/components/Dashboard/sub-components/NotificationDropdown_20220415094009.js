  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center ">
        <span className="font-bold text-tclPrimary text-lg">Recent</span>
        <button
          onClick={hide}
          className="text-xl mb-2 text-black hover:text-red-700"
        >
          <FaTimesCircle />
        </button>
      </div>
...
const NotificationItem = ({
  ...
  return (
    <p className="w-full last:border-none rounded-t rounded-b-none last:rounded-t-none rounded-md last:rounded-b last:rounded-md border-b border-gray-300 p-2 text-gray-700 hover:bg-gray-100">
      {item}
    </p>
  );
};
