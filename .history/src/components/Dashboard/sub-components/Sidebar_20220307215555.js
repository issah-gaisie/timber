...
const Sidebar = () => {
  return (
    <nav className="h-full bg-white shadow-xs min-w-[4rem] basis-[5%] flex-col items-center justify-start space-y-10 pt-10 hidden md:flex">
      ...
      <div className=" flex justify-center items-center bg-red-700 hover:bg-red-900 p-2 rounded rounded-full mt-12">
