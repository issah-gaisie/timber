...
const FloatingBottomNavBar = () => {
  return (
    <nav className="flex md:hidden w-full items-center justify-around bg-white shadow-sm absolute bottom-0 py-3  m-auto">
      ...
      <div className="flex justify-center items-center bg-red-700  py-2 justify-self-end">
        <RiShutDownLine className="text-3xl text-red-600" />
      </div>
    </nav>
  );
};
