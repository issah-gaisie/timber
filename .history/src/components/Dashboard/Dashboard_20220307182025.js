...
const SettingsPopup = () => {
  return (
    <div className="flex flex-col bg-white shadow-md rounded rounded-lg absolute right-0 top-full p-3 w-32 ">
      <button className="w-full py-1 text-md rounded rounded-sm hover:bg-[#D3F3BE]  hover:text-lime-700 mb-2 ">
        Settings
      </button>
