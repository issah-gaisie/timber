  ...
  return (
    <div className="bg-white rounded rounded lg flex justify-center items-center flex-col p-3">
      <div className="h-16 w-16 relative">
        ...
        />
        <span className=" block text-center absolute -bottom-2 uppercase rounded rounded-full bg-[#DEF6D0] text-[#4B971C] px-2  font-medium text-xs border border-[#4B971C]/50">{role}</span>
      </div>
    </div>
  );
};
