...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-gray-100">
      {/* Dashboard Header */}
      <header className="flex justify-between items-center h-14 shadow-sm bg-white px-2 md:px-6 relative">
        <img src={logo} alt="tcl" className="h-10 w-auto object-contain" />
        <div
          className="hidden justify-center items-center space-x-2 pointer md:flex"
          onClick={togglePopup}
        >
