...
const SideBar = () => {
  return (
    <nav className="h-full bg-white shadow-xs basis-1/12 flex-col items-center justify- space-y-10 pt-10 hidden md:flex">
      ...
      <div className="w-full flex justify-center items-center bg-red-700 py-2 justify-self-end">
