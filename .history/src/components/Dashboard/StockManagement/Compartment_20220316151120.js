...
const Compartment = () => {
  ...
  <FormGrid>
    ...
    <label className="block">
      <span className="block text-md  text-gray-700 mb-3">Select Concession</span>
      <Select
        type="text"
  ...
  <button
    type="submit"
    className="w-full sm:w-auto md:px-3 bg-[#3e7c17] hover:bg-[#356C14] text-white font-semibold py-2 lg:py-3 my-3 rounded rounded-md self-end"
  >
    Create Compartment
  </button>
</form>;
