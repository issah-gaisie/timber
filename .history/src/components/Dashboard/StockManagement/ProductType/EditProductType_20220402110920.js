...
const EditProductType = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const editProductTypePromise = new Promise((resolve, reject) =>
      setTimeout(
        () =>
          resolve({
            message: "Product Type Edited Successfully",
            status: 200,
            data: [],
          }),
        1000
    ...
    await toast.promise(editProductTypePromise, {
      loading: "Editing Product Type",
      success: "Product Type Edited Successfully",
      error: "Product Type Edit Failed",
    });
    setDisabled(true);
  };
  return (
