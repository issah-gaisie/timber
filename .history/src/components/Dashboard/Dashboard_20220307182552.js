...
const SettingsPopup = () => {
  return (
    <div className="flex flex-col bg-white shadow-md rounded rounded-lg absolute right-0 top-[125%] p-3 w-40">
      <div className="h-12 w-8 rounded rounded-full bg-green-700"></div>
