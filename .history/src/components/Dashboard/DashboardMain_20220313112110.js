  ...
  return (
    <div className="w-full h-full p-6 flex flex-col items-start">
      ...
      <div className="w-full grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <LabelAndValue label={'Active Users'} value={state.activeUsers+state.deactivatedUsers} className='ring ring-green-500 bg-green-100 ' />
        <LabelAndValue label={'Deactivated Users'} value={state.activeUsers+state.deactivatedUsers} className='ring ring-green-500 bg-green-100 ' />
