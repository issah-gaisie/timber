  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-gray-100">
      <div className="flex justify-between items-center h-14 shadow-sm bg-white px-6">
        ...
        <div
          className=" hover:ring-2 hover:ring-green-700/25 hover:p-1 rounded rounded-md flex justify-center items-center space-x-2 pointer relative"
          onClick={togglePopup}
        >
  ...
  return (
    <div className="flex flex-col items-center bg-white shadow-md rounded rounded-lg absolute right-0 top-[125%] p-3 w-40 ">
      ...
      <button className="group2">
        <RiSettings5Line className="group2-hover:hidden" />
        <RiSettings5Fill className="hidden group2-hover:block" />
      </button>
