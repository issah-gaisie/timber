...
const OrderDetails = () => {
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <button
        type="button"
        className="w-auto bg-gray-700 hover:bg-gray-800 py-2 px-4 text-white text-medium font-semibold shadow-lg rounded rounded-md flex items-center"
      >
        <RiFileDownloadLine className="text-white" />
