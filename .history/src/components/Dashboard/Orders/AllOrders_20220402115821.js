...
const FilterByClient = ({
  ...
  return (
    <div className="flex flex items-stretch space-x-3 justify-end">
      ...
      {shouldFilter ? (
        <button
          className="rounded rounded-md bg-red-800 text-white py-1 px-2"
        ...
        <button
          className="rounded rounded-md bg-gray-700 hover:bg-gray-800 hover:shad text-white py-1.5 px-2"
          onClick={toggleFilters}
        >
          Filter by Client
        </button>
