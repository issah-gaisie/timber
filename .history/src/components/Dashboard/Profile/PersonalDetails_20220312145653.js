    ...
    <div className="flex flex-col w-full">
        ...
        <div>
          {disabled ? (
            <div className="">
              ...
              <button
                onClick={toggleDisable}
                className="hidden md:block bg-gray-700 hover:bg-gray-800 py-2 px-4 text-white text-medium font-semibold shadow-lg rounded rounded-lg"
              >
                Edit
              </button>
            </div>
            ...
            <div>
              ...
              <button
                onClick={toggleDisable}
                className="hidden md:block bg-red-700 hover:bg-red-800 py-2 px-4 text-white text-medium font-semibold shadow-lg rounded rounded-lg"
              >
                Cancel
              </button>
            </div>
      ...
      >
        <label
          className={`block ${
            disabled ? "" : "md:flex"
          } mb-3 md:items-end mr-2`}
        >
          <span
            className={`block text-left md:flex text-md font-medium text-gray-700 mb-3 min-w-[10rem]`}
          >
            Username
          </span>
