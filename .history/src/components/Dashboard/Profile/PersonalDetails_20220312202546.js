...
export const ProfileImageSection = ({ onChange }) => {
  ...
  return (
    <div className="w-full flex justify-center sm:justify-start items-center mb-6 ">
      ...
      />
      <div
        className="bg-co h-24 w-24 rounded rounded-full border-2 border-gray-200 shadow-sm flex justify-center items-center pointer bg-cover bg-no-repeat bg-center self-center"
