...
const SettingsPopup = () => {
  return (
    <div className="flex flex-col bg-white shadow-md rounded rounded-lg absolute right-0 top-0 p-3 w-32 ">
      <button className="w-full py-1 hover:bg-green-200 hover:text-white mb-2 rounded rounded-sm">
        Settings
      </button>
      <button className="w-full py-1 bg-red-600 hover:bg-red-700 text-white hover:font-semibold">
        Logout
      </button>
    </div>
  );
