...
const SettingsPopup = () => {
  return (
    <div className="flex flex-col bg-white shadow-md rounded rounded-lg absolute right-0 top-full p-3 w-40 ring ring-lime-600/50 ">
      <button className="w-full py-1  rounded rounded-sm hover:bg-[#D3F3BE]  hover:text-lime-700 mb-2 ">
        Settings
      </button>
